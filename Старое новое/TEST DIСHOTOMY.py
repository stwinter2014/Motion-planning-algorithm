...
feedrate = [30, 25, 25, 25, 25]     #list of feedrates for each block
feedrate_max = [60, 75, 60, 50, 60]
acceleration = [30, 30, 30, 30, 5000] #allowable acceleration for each block
deceleration = [5000, 5000, 5000, 5000, 5000] #allowable deceleration for each block
jerk = [50, 50, 50000, 50000, 50000]
#период интерполяции
